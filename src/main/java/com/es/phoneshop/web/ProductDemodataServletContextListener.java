...
public class ProductDemodataServletContextListener implements ServletContextListener {
    ...
    private synchronized List<Product> fillProductList() {
        ...
        product.getPrice().add(new ProductPrice("10 Jan 2019", new BigDecimal(100)));
        product.getPrice().add(new ProductPrice("10 Oct 2018", new BigDecimal(110)));
        product.getPrice().add(new ProductPrice("1 Sep 2018", new BigDecimal(150)));
        result.add(product);
        ...
        product.getPrice().add(new ProductPrice("10 Jan 2019", new BigDecimal(200)));
        product.getPrice().add(new ProductPrice("10 Oct 2018", new BigDecimal(220)));
        product.getPrice().add(new ProductPrice("1 Sep 2018", new BigDecimal(270)));
        result.add(product);
        ...
        product.getPrice().add(new ProductPrice("10 Jan 2019", new BigDecimal(300)));
        product.getPrice().add(new ProductPrice("10 Oct 2018", new BigDecimal(350)));
        product.getPrice().add(new ProductPrice("1 Sep 2018", new BigDecimal(420)));
        result.add(product);
        ...
        product.getPrice().add(new ProductPrice("10 Jan 2019", new BigDecimal(200)));
        product.getPrice().add(new ProductPrice("10 Oct 2018", new BigDecimal(250)));
        product.getPrice().add(new ProductPrice("1 Sep 2018", new BigDecimal(320)));
        result.add(product);
        ...
        product.getPrice().add(new ProductPrice("10 Jan 2019", new BigDecimal(1000)));
        product.getPrice().add(new ProductPrice("10 Oct 2018", new BigDecimal(1250)));
        product.getPrice().add(new ProductPrice("1 Sep 2018", new BigDecimal(1320)));
        result.add(product);
        ...
        product.getPrice().add(new ProductPrice("10 Jan 2019", new BigDecimal(350)));
        product.getPrice().add(new ProductPrice("10 Oct 2018", new BigDecimal(450)));
        product.getPrice().add(new ProductPrice("1 Sep 2018", new BigDecimal(520)));
        result.add(product);
        ...
        product.getPrice().add(new ProductPrice("10 Jan 2019", new BigDecimal(420)));
        product.getPrice().add(new ProductPrice("10 Oct 2018", new BigDecimal(480)));
        product.getPrice().add(new ProductPrice("1 Sep 2018", new BigDecimal(520)));
        result.add(product);
        ...
        product.getPrice().add(new ProductPrice("10 Jan 2019", new BigDecimal(120)));
        product.getPrice().add(new ProductPrice("10 Oct 2018", new BigDecimal(150)));
        product.getPrice().add(new ProductPrice("1 Sep 2018", new BigDecimal(170)));
        result.add(product);
        ...
        product.getPrice().add(new ProductPrice("10 Jan 2019", new BigDecimal(70)));
        product.getPrice().add(new ProductPrice("10 Oct 2018", new BigDecimal(100)));
        product.getPrice().add(new ProductPrice("1 Sep 2018", new BigDecimal(120)));
        result.add(product);
        ...
        product.getPrice().add(new ProductPrice("10 Jan 2019", new BigDecimal(170)));
        product.getPrice().add(new ProductPrice("10 Oct 2018", new BigDecimal(200)));
        product.getPrice().add(new ProductPrice("1 Sep 2018", new BigDecimal(220)));
        result.add(product);
        ...
        product.getPrice().add(new ProductPrice("10 Jan 2019", new BigDecimal(80)));
        product.getPrice().add(new ProductPrice("10 Oct 2018", new BigDecimal(110)));
        product.getPrice().add(new ProductPrice("1 Sep 2018", new BigDecimal(130)));
        result.add(product);
        ...
        product.getPrice().add(new ProductPrice("10 Oct 2018", new BigDecimal(180)));
        product.getPrice().add(new ProductPrice("1 Sep 2018", new BigDecimal(200)));
        result.add(product);
        return result;
    }
}
